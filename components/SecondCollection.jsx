...
export default function SecondCollection() {
  ...
  return (
    <div className="secondCollection mt-4">
        <h1 ref={titleRef} className="text-capitalize px-2 text-center" style={{
        ...
        <div ref={buttonsRef} style={{transform:isInView2 ? "none" : "translateY(30px)",opacity: isInView2 ? 1 : 0,transition: "all 0.9s cubic-bezier(0.17, 0.55, 0.55, 1) 0.5s"}} className="d-flex justify-content-center gap-5">
        ...
        <div className="d-flex gap-2 mt-3 px-lg-3 px-2 flex-wrap flex-md-nowrap justify-content-center">
          <SecondCard/>
